...
@section('content')
    ...
    <p class="text-end"><a href="{{ $feedUrl }}" target="_blank"
    ...
    <p>Pro tip: you can be redirected after refreshing by passing a <code>redirectTo</code> parameter to this URL.</p>

    <p>Note: feeds that are not refreshed within 30 days are removed automatically.</p>
